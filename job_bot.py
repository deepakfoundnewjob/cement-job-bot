...
send_telegram("✅ Executive Company Tracking Bot is now LIVE.")
...
def check_email():
    ...
    try:
        ...
        for num in messages[0].split():
            ...
            if (
                any(ind in full_text for ind in industry_keywords)
                and any(role in full_text for role in leadership_keywords)
                and any(comp in full_text for comp in company_keywords)
            ):
